...
GameBoard.pList = new Array(14 * 10); // 64 casillas, key para la posición
GameBoard.posKey = 0;

//Debemos tener en cuenta estas nuevas variables, ya que se necesitarán almomento de limpiar pantalla
